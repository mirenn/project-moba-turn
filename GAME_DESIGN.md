...
| カード名 | タイプ | 優先度 | 攻撃力 | 移動 | 効果 |
|----------|--------|--------|--------|------|------|
| かえんほうしゃ | ほのお | 65 | 90 | 0マス | 2マス以内の1体に攻撃 |
| フレアドライブ | ほのお | 80 | 120 | 2マス | 2マス移動後、隣接1体に攻撃。自分も1/3ダメージを受ける |
| ほのおのキバ | ほのお | 95 | 65 | 1マス | 隣接1体に攻撃。10%で相手をやけど状態にする |
...
| カード名 | タイプ | 優先度 | 攻撃力 | 移動 | 効果 |
|----------|--------|--------|--------|------|------|
| 10まんボルト | でんき | 70 | 90 | 0マス | 2マス以内の1体に攻撃。10%で相手をまひ状態にする |
| でんこうせっか | ノーマル | 115 | 40 | 2マス | 2マス移動後、隣接1体に攻撃 |
| ボルトチェンジ | でんき | 85 | 70 | 0マス | 2マス以内の1体に攻撃。成功時、控えと交代 |
